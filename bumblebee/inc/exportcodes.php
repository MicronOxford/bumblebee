...
define('EXPORT_FORMAT_USEHTML',   EXPORT_FORMAT_USEARRAY|128);
define('EXPORT_FORMAT_VIEWOPEN',  EXPORT_FORMAT_USEHTML|256);
define('EXPORT_FORMAT_VIEW',      EXPORT_FORMAT_USEHTML|512);
